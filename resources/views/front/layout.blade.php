            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  @if(session()->has('FRONT_USER_ID')!=null)
          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="#" id="carrtbox_link">
                  <span class="fa fa-shopping-basket"></span>
                  <span class="aa-cart-title">SHOPPING CART</span>
                  <span class="aa-cart-notify">{{sizeof(getCardData())}}</span>
                </a>
                <div class="aa-cartbox-summary">
                  @if(sizeof(getCardData()) != 0)
                  ...
                  <ul>
                      ...
                      @foreach(getCardData() as $data)
                          ...
                          @endphp
                    <li>
                      <a class="aa-cartbox-img" href="{{url('product/'.$data->slug)}}"><img src="{{ asset('storage/media/'.$data->image) }}" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="#">{{$data->name}}</a></h4>
                        <p>{{$data->qty}} x {{$data->price}}</p>
                      </div>
                      <a class="aa-remove-product" href="javascript:void(0)" onclick="deleteProductCart('{{$data->pid}}','{{$data->size}}', '{{$data->color}}', '{{$data->attr_id}}')"><span class="fa fa-times"></span></a>
                    </li>
                    @endforeach
                          <li>
      ...
      <div class="modal-content">
        ...
        <div id="popup_login">
            ...
            <form class="aa-login-form" action="" id="frmLogin">
              <label for="str_login_email">Email<span>*</span></label>
              <input type="text" placeholder="email" name="str_login_email" value="{{$login_email}}">
              <label for="str_login_password">Password<span>*</span></label>
        ...
        <div id="popup_forgot" style="display:none;">
            ...
            <form class="aa-forgot-form" action="" id="frmForgot">
              <label for="str_forgot_email">Email<span>*</span></label>
              <input type="text" placeholder="forgot email" name="str_forgot_email">
              <br><br>
              <button class="aa-browse-btn" type="submit" id="btnForgot">Forgot</button>

             <br>
              <div id="str_forgot_msg"></div>
